...
const BlogDetail: React.FC = () => {
    ...
    const article = {
        ...
        content: post && (post as any).content ? (post as any).content : `
            ...
            <p class="mb-6 text-lg leading-relaxed text-gray-600">Full article content should be supplied by your CMS or data source.</p>
        `
    };

    // SEO Data
    let seoTitle = `${article.title} | Memo InfoTech Blog`;
    let seoDesc = article.subtitle;
    if (post && (post as any).slug === 'it-company-in-nagercoil') {
        seoTitle = 'Best IT & Digital Solutions Company in Nagercoil | Memo InfoTech';
        seoDesc = 'Looking for a trusted IT company in Nagercoil? Memo InfoTech offers complete digital solutions including web development, software, apps, SEO & branding. Call today.';
    }
    ...
    const breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": article.title, "item": `https://www.memoinfotech.com/blog/${id}/` }
        ]
    };
    ...
    const articleSchema = {
        ...
        "publisher": {
            ...
            "logo": {
                "@type": "ImageObject",
                "url": "https://www.memoinfotech.com/assets/logo.png"
            }
        }
    };
    ...
    return (
        <div ref={containerRef} className="bg-white w-full min-h-screen">
            <SEO
                ...
                canonical={`https://www.memoinfotech.com/blog/${id}/`}
