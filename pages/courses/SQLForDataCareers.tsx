  ...
  const curriculum = [
    {
      ...
      topics: ["SELECT Statements", "WHERE & Filtering", "JOINs", "Aggregations"],
      duration: "1 week"
    },
    {
      module: "Module 2: Advanced Queries",
      topics: ["Subqueries", "Window Functions", "CTEs", "Query Optimization"],
      duration: "1 week"
    },
    {
      module: "Module 3: Database Management",
      topics: ["Data Manipulation", "Transaction Control", "Indexes", "Stored Procedures"],
      duration: "1 week"
    },
    {
      module: "Module 4: Real-World Data Projects",
      topics: ["Business Analysis", "Reporting", "Performance Tuning"],
      duration: "1 week"
    }
  ];
      ...
      <section className="py-32 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4 line-clamp-2">
                  Analyze data, build dashboards, and derive insights using Python, pandas, and visualization tools.
                </p>
            ...
            <Link
              to="/academy/business-intelligence"
              className="group rounded-[2rem] overflow-hidden border border-gray-200 hover:border-[#007BFF] bg-white transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 block"
            >
              <div className="h-56 overflow-hidden bg-gray-200 relative">
                <img
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4 line-clamp-2">
                  Learn BI tools, ETL concepts, reporting, and how to turn data into strategic business decisions.
                </p>
                <div className="space-y-2 mb-6">
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    <CheckCircle size={16} className="text-[#007BFF]" />
