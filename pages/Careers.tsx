...
const Careers: React.FC = () => {
    ...
    const breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Careers", "item": "https://www.memoinfotech.com/careers/" }
        ]
    };
        ...
        "itemListElement": jobs.map((job, index) => ({
            ...
            "item": {
                ...
                "hiringOrganization": {
                    "@type": "Organization",
                    "name": "Memo InfoTech",
                    "sameAs": "https://www.memoinfotech.com"
                },
                "description": `Join Memo InfoTech as a ${job.role}. We are looking for talented individuals in ${job.dept}.`
            }
        }))
    };
    ...
    return (
        <div ref={containerRef} className="w-full bg-white">
            <SEO
                ...
                canonical="https://www.memoinfotech.com/careers/"
                schemas={[breadcrumbSchema, jobSchema]}
            />
            <SEO
                title="Careers — Join Memo Infotech"
                description="Explore open roles for designers, developers, and product specialists. Learn about benefits, culture, and how we work."
            />
