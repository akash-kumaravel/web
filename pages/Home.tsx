...
const Home: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="bg-white w-full overflow-x-hidden">
      <SEO
        title="Best IT Company & Web Development in Nagercoil"
        ...
        canonical="https://www.memoinfotech.com/"
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="relative w-full min-h-[300px] flex items-center justify-center">
                {testimonials.map((t, i) => (
                  <div
                    key={t.id}
                    className={`absolute inset-0 flex flex-col items-center justify-center transition-all duration-700 ease-in-out transform ${i === activeTestimonial
              ...
              <div className="flex gap-3 mt-12 z-20">
                {testimonials.map((_, i) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${i === activeTestimonial ? 'bg-[#007BFF] scale-125' : 'bg-gray-700 hover:bg-gray-500'
                      }`}
                  />
                ))}
              </div>
