...
const ItCompanyInNagercoil: React.FC = () => {
  ...
  const faqs = [
    {
      q: 'What services does Memo Infotech provide as an IT company?',
      a: 'Memo Infotech provides comprehensive IT services including web development, custom software development, mobile app development, database solutions, hosting and cloud services, and quality assurance testing for businesses across India.'
    },
    {
      q: 'Where is Memo Infotech located?',
      a: 'Memo Infotech is headquartered in Nagercoil, Tamil Nadu, India. We serve clients across India including Chennai, Bangalore, Coimbatore, Hyderabad, Mumbai, Delhi, Pune, and other regions.'
    },
    {
      q: 'Does Memo Infotech work with startups and small businesses?',
      a: 'Yes, Memo Infotech works with startups, small businesses, and large enterprises. We tailor our IT solutions to meet the specific needs and budget requirements of each client.'
    },
    {
      q: 'What technologies does Memo Infotech use?',
      a: 'We use modern technologies including React, Node.js, Python, PHP, Laravel, MySQL, PostgreSQL, AWS, Docker, JavaScript, and TypeScript to deliver cutting-edge IT solutions.'
    },
    {
      q: 'How can I contact Memo Infotech for a free consultation?',
      a: 'You can contact us by calling +91 6374433734, visiting our contact page, or emailing hello@memoinfotech.com. We offer free consultations for all IT service inquiries.'
    }
  ];
  ...
  return (
    <div ref={containerRef} className="w-full bg-white">
      <SEO
        title="IT Company in Nagercoil | Web Development & IT Services"
        description="Memo Infotech is a trusted IT company in Nagercoil providing web development, software solutions, and IT services for businesses across India. Get scalable and affordable IT solutions."
        ...
        canonical="https://www.memoinfotech.com/it-company-in-nagercoil/"
        ogImage="https://www.memoinfotech.com/assets/it-company-nagercoil-og.jpg"
        ogTitle="IT Company in Nagercoil - Web Development & Software Solutions"
        ogDescription="Trusted IT company providing web development, software solutions, and IT services across India. Memo Infotech, based in Nagercoil."
        schemas={[breadcrumbSchema, orgSchema, faqSchema, serviceSchema]}
      />
      {/* Hero Section */}
