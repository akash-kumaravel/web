...
const TestingQA: React.FC = () => {
  useEffect(() => {
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Testing & QA",
          "item": "https://www.memoinfotech.com/testing-qa/"
        }
      ]
    };
    ...
    const serviceSchema = {
      ...
      "description": "Comprehensive testing services: manual testing, automated testing, performance testing, security testing, and QA consulting.",
      "provider": {
        "@type": "Organization",
        "name": "MEMO InfoTech",
