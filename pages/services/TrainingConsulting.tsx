...
const TrainingConsulting: React.FC = () => {
  useEffect(() => {
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.memoinfotech.com/training-consulting/"
        }
      ]
    };
    ...
    const serviceSchema = {
      ...
      "@type": "Service",
      "name": "Training & Consulting",
      "description": "Professional training programs, internship opportunities, consulting services for technology upskilling and business transformation.",
      "provider": {
        "@type": "Organization",
        "name": "MEMO InfoTech",
