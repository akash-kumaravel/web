...
const WebDesignDevelopment: React.FC = () => {
  useEffect(() => {
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.memoinfotech.com/web-design-development/"
        }
      ]
    };
    ...
    const serviceSchema = {
      ...
      "@type": "Service",
      "name": "Web Design & Development",
      "description": "Expert web design and development services including static sites, dynamic web applications, e-commerce platforms, and website maintenance.",
      "provider": {
        "@type": "Organization",
        "name": "MEMO InfoTech",
