...
const AIAutomation: React.FC = () => {
  useEffect(() => {
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "AI & Automation",
          "item": "https://www.memoinfotech.com/ai-automation/"
        }
      ]
    };
    ...
    const serviceSchema = {
      ...
      "@type": "Service",
      "name": "AI & Automation",
      "description": "Leverage AI, machine learning, chatbots, process automation, and advanced analytics to transform your business operations.",
      "provider": {
        "@type": "Organization",
        "name": "MEMO InfoTech",
