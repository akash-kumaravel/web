...
const BgwrapPrivacyPolicy: React.FC = () => {
  return (
    <div className="pt-40 pb-20 w-full bg-white">
      <SEO
        title="BGWRAP Privacy Policy"
        description="Privacy Policy for the BGWRAP - Background Remover mobile application."
        canonical="/bgwrap-privacy-policy/"
      />
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="mb-12">
          ...
          <h1 className="text-5xl md:text-[4rem] font-bold font-['Syne'] leading-none text-black mb-4">Privacy Policy</h1>
          <p className="text-xl text-gray-500">Last updated: May 26, 2026</p>
        </div>

        <div className="space-y-8 text-lg text-gray-600 leading-relaxed">
          <section>
            <p className="mb-2">
              This privacy policy applies to the BGWRAP - Background Remover app for mobile devices, together with any related services operated by Memo Infotech (collectively, the "Application"). Memo Infotech is hereby referred to as the "Service Provider".
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-black mb-2">Information Collection and Use</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-2">Cookies and tracking technologies</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-2">Third Party Access</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-2">International Data Transfers</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-2">Opt-Out Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-2">Data Retention Policy</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-2">Children</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-2">Data Breach Notification</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-2">Changes</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-2">Your Consent</h2>
            <p>
...
export default BgwrapPrivacyPolicy;
